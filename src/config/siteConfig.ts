...
export const siteConfig: SiteConfig = {
  title: "魔女哈希双叉",
  subtitle: "YxlaGyb",
  site_url: "https://blog.klbbx.cc",
  description:
    "魔女螃蟹哈希双叉是一个技术博客, 致力于分享日常与代码战斗的技术经验, 主要以人工智能领域且覆盖前后端相关领域, 番外还有其它内容的分享例如，Galgame分享、好看的壁纸分享、游戏推荐和攻略等等......",
  keywords: [
    "AI",
    "人工智能",
    "Astro",
  ...
  //   alt: "🍀",
  // },
  navbarTitle: "魔女哈希双叉", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
  navbarWidthFull: false, // 全宽导航栏，导航栏是否占满屏幕宽度，true：占满，false：不占满

  // 站点开始日期，用于统计运行天数
  siteStartDate: "2022-05-26", // 请修改为你的站点实际开始日期，格式：YYYY-MM-DD

  // bangumi配置
  bangumi: {
    userId: "1176932", // 在此处设置你的Bangumi用户ID
  },
